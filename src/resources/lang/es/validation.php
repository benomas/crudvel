...
$cvValidations = [
	...
	*/
	...
	'cv_true_when_true'          => 'El campo [:attribute] debe tener un valor verdadero, cuando el campo [:other] es verdadero',
	'cv_true_when_false'         => 'El campo [:attribute] debe tener un valor verdadero, cuando el campo [:other] es falso',
	'cv_false_when_true'         => 'El campo [:attribute] debe tener un valor falso, cuando el campo [:other] es verdadero',
	'cv_false_when_false'        => 'El campo [:attribute] debe tener un valor falso, cuando el campo [:other] es falso',
	'cv_true_when_greater_than'  => 'El campo [:attribute] debe tener un valor verdadero, cuando el campo [:other] es mayor que [:limit]',
	'cv_false_when_greater_than' => 'El campo [:attribute] debe tener un valor falso, cuando el campo [:other] es mayor que [:limit]',
	'cv_true_when_less_than'     => 'El campo [:attribute] debe tener un valor verdadero, cuando el campo [:other] es menor que [:limit]',
	'cv_false_when_less_than'    => 'El campo [:attribute] debe tener un valor falso, cuando el campo [:other] es menor que [:limit]',
