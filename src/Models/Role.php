...
// [Relationships]
  public function users(){
    return $this->belongsToMany("App\Models\User", "role_user")->disableRestriction();
  }
  ...
  public function domineeringRoles(){
    return $this->belongsToMany("App\Models\Role", 'domineering_role_domined_role', 'domined_role_id', 'domineering_role_id')->disableRestriction();
  }

  public function dominedRoles(){
    return $this->belongsToMany("App\Models\Role", 'domineering_role_domined_role', 'domineering_role_id', 'domined_role_id')->disableRestriction();
  }
// [End Relationships]
...
//Non standar Relationships
  ...
  public function resourcePermissions(){
    return $this->belongsToMany("App\Models\Permission", "permission_role")->resourcePermissions();
  }
