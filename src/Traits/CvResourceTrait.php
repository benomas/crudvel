...
trait CvResourceTrait
{
  ...
  public function getBase64Fields(){
    return $this->fields['b64Query']??null;
  }
  ...
  public function setBase64Fields($base64Fields=null){
    $this->fields['base64Felds'] = $base64Fields ?? null;
